 ...
 * @author leojay
 */
public interface DatabaseConnection<F> {
    /**
     * 用来实现与数据库的交互,一般要求在使用完 链接类 后，还需关闭链接类
     * <p>
     * 具体使用方式可参照
     * leojay.tools.leojay.tools.java.database2.mysql.MySQLOperation类的
     * SQLRequest(MyOperation.Mode, OnResponse)方法，如下连接
     *
     * @param listener 链接监听
     */
    void createConnect(OnConnectListener<F> listener);
    ...
    interface OnConnectListener<F> {
         ...
         */
        void done(F conn) throws SQLException;
    }
}
